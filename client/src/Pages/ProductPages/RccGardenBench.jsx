...
const ProductShowcase = () => {
  const products = [
    {
      name: "With Arm Rest 3 Seater Cast Iron Park Bench, For Long Lasting And Durable, With Back",
      price: "17,999",
      images: [
      ...
      specs: {
        ...
        "Usage/Application": "Garden / Park",
        "Country of Origin": "Made in India",
      },
      description:
        "As pioneers in the industry, we proudly offer a durable and long-lasting 3-seater RCC garden bench featuring sturdy cast iron armrests and a comfortable backrest. Crafted with premium quality materials and expert workmanship from India, this bench is designed to withstand outdoor conditions while providing both strength and comfort. Ideal for parks, gardens, and public spaces, it combines classic design with robust construction to enhance any outdoor environment.",
    },
  ];
...
const RccGardenBenchProductPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Ideal for parks, residential gardens, and public spaces, this RCC garden bench offers durable, comfortable seating with low maintenance.",
    },
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                RCC Garden Bench That Stand the Test of Time
              </h1>
              ...
              <p className="text-lg mb-8 leading-relaxed text-gray-600">
                We are pioneers in the industry, offering a high-quality
                3-seater cast iron park bench with armrests and a supportive
                backrest. Designed for long-lasting durability, this bench
                combines strength, comfort, and classic style—making it ideal
                for parks, gardens, public spaces, and outdoor settings. Proudly
                manufactured in India, it reflects superior craftsmanship and
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="https://5.imimg.com/data5/SELLER/Default/2025/4/503687657/RJ/QC/AY/192062814/with-arm-rest-3-seater-cast-iron-park-bench-for-long-lasting-and-durable-with-back-500x500.jpg"
                  alt="RCC Garden Bench Construction"
        ...
        <div className="container mx-auto px-4">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Why Choose Our{" "}
              <span className="text-blue-600">RCC Garden Bench</span>?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the perfect blend of strength, durability, and
              cost-effectiveness with our premium RCC Garden Bench solutions.
            </p>
          </motion.div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our RCC Garden Bench are versatile solutions suitable for various
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Our <span className="text-blue-600">RCC Garden Bench</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Pioneers in the industry, we offer with arm rest 3 seater cast
              iron park bench, for long lasting and durable, with back from
              India.
            </p>
          </motion.div>
...
export default RccGardenBenchProductPage;
